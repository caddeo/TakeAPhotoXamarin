        ...
        public IHttpActionResult Get()
        {
            try
            {
                ...
                lock (_lock)
                {
                    ...
                    images = _database.Images.ToListAsync().Result;
                }
